...
# VitalGuard AI v4.3.0 — Spirit of inquiry : [ These experimental modules are intentionally excluded from the strict zero-network-egress guarantee that applies to the core clean audit build.]
